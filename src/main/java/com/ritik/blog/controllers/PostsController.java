...
public class PostsController {
	...
	@GetMapping("/posts")
	public ResponseEntity<PostResponse> getAllPosts(@RequestParam(value = "pageNumber" , defaultValue = AppConstants.PAGE_NUMBER,
	required = false) Integer pageNo, @RequestParam(value = "pageSize", defaultValue = AppConstants.PAGE_SIZE,required = false) Integer pSize
	...
	public ResponseEntity<PostsDto> updatePost(@Valid @RequestBody PostsDto postsDto, @PathVariable(name = "postId") Integer pId)
	{
	...
	public ResponseEntity<PostsDto> uploadPostImage(@PathVariable(name="postId") Integer id, @RequestParam("image") MultipartFile image )
	{
